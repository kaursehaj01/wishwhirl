...
// import { FaList } from "react-icons/fa";
// import Item from '../components/item/Item';
// import img from '../assets/images/bannerOne.webp'
...
//                 {/* mmmm */}
//                 <div className="lg:col-span-3">
//                   {/* shopcategory start from here */}
//                   <div className="shop-category popular w-full pb-[80px] px-4  pt-[10px]">
//                     <img src={props.banner} alt="" className='shopcategory-banner mb-[10px] block md:mx-20px w-full h-auto md:w-11/12 md:my-[10px]' />
...
//                       <button type="button" className="-m-2 ml-3 p-2 text-gray-400 hover:text-gray-500 sm:ml-3">
//                         <span className="sr-only">list grid</span>
//                         <FaList aria-hidden="true" className="size-5" />
//                       </button>
//                       </div>
//                       <div className=" flex flex-col sm:flex-row ">
//                         <p className="text-gray-700 text-xs md:text-sm font-bold mr-2">
//                           Showing 1-12 of 36
//                         </p>
//                       </div>
//                     </div>
...
//                     <div className="shopcategory-product w-full gap-x-6 gap-y-10 grid grid-cols-1  sm:grid-cols-3 lg:grid-cols-4 xl:gap-x-8">
...
//                       })}
//                     </div>
//                     <div className="shopcategory-loadmore my-4 flex justify-center items-center ">
//                       <button className="bg-slate-800 rounded-md cursor-pointer hover:bg-black active:bg-gray-900 px-8 py-2 font-titleFont font-semibold text-lg text-gray-200 hover:text-white duration-300 ">Explore More </button>
...
//             {/* yeah navbar */}
//             <div className="flex items-baseline justify-between border-b border-gray-200 pb-2 pt-5 px-3">  
//               <h1 className="text-2xl font-bold tracking-tight text-gray-900 capitalize">{props.category}'s collection</h1>
